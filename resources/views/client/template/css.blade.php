...
<link rel="stylesheet" href="{{asset('client_template')}}/css/owl.carousel.min.css">
<link rel="stylesheet" href="{{asset('client_template')}}/css/owl.theme.default.min.css">
<link rel="stylesheet" href="{{asset('client_template')}}/css/magnific-popup.css">

<link rel="stylesheet" href="{{asset('client_template')}}/css/aos.css">

<link rel="stylesheet" href="{{asset('client_template')}}/css/ionicons.min.css">

<link rel="stylesheet" href="{{asset('client_template')}}/css/bootstrap-datepicker.css">
<link rel="stylesheet" href="{{asset('client_template')}}/css/jquery.timepicker.css">
